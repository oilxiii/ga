GUNDAM ASSEMBLE // ONLINE — Launch Candidate v51
...
- เพลง Gundam 8-bit จะลูปเฉพาะหน้า Title; เมื่อเริ่มเกมเพลงนี้จะหยุดและเปลี่ยนเป็นเพลงต่อสู้เดิม
- ปุ่มลำโพงมุมขวาบนใช้เปิด/ปิดทั้งเพลงและเสียงเอฟเฟกต์
